...
@usableFromInline struct DocumentPicker: UIViewControllerRepresentable {
    ...
    @usableFromInline class Coordinator: NSObject {
        ...
        init(_ parent: DocumentPicker) {
            self.parent = parent
            //self.pickerController = UIDocumentPickerViewController(documentTypes: parent.documentTypes, in: .open)
            self.pickerController = UIDocumentPickerViewController(forOpeningContentTypes: [.commaSeparatedText])
